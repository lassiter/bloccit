...
describe "GET new" do
  ...
  describe "POST create" do
    it "increases the number of SponsoredPost by 1" do
       expect{ post :create, params: { topic_id: my_topic.id, sponsoredpost: { title: RandomData.random_sentence, body: RandomData.random_paragraph, price: RandomData.random_price } } }.to change(SponsoredPost,:count).by(1)
    end
   ...
   describe "PUT update" do
     it "updates post with expected attributes" do
       ...
       put :update, params: { topic_id: my_topic.id, id: my_sponsored_post.id, sponsoredpost: { title: new_title, body: new_body, price: new_price } }
