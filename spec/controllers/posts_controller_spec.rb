  ...
  context "guest" do
    describe "GET show" do
      it "returns http success" do
        get :show, params: { topic_id: my_post.topic.id, id: my_post.id }
    ...
    describe "GET edit" do
      it "returns http redirect" do
        get :edit, params: { topic_id: my_post.topic.id, id: my_post.id }
        expect(response).to redirect_to(new_session_path)
      end
    end
    ...
    describe "DELETE destroy" do
      it "returns http redirect" do
        delete :destroy, params: { topic_id: my_post.topic.id, id: my_post.id }
        expect(response).to redirect_to(new_session_path)
      end
    end
  end
  ...
  context "member user doing CRUD on a post they own" do
    ...
    describe "DELETE destroy" do
      ...
      it "redirects to posts index" do
        delete :destroy, params: { topic_id: my_post.topic.id, id: my_post.id }
        expect(response).to redirect_to [my_post.topic]
      end
    end
  end

  context "moderator user doing CRUD on a post they don't own" do
    # Should be able to create and update posts, but not delete.
    before do
